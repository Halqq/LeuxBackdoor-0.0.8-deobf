...
final class Item {
  ...
  void set(int paramInt, String paramString1, String paramString2, String paramString3) {
    ...
    switch (paramInt) {
      ...
      case 30:
        ...
        return;
      case 12:
        this.hashCode = Integer.MAX_VALUE & paramInt + paramString1.hashCode() * paramString2.hashCode();
        return;
    } 
    this.hashCode = Integer.MAX_VALUE & paramInt + paramString1.hashCode() * paramString2.hashCode() * paramString3.hashCode();
  }
  ...
  void set(String paramString1, String paramString2, int paramInt) {
    ...
    this.strVal1 = paramString1;
    this.strVal2 = paramString2;
    this.hashCode = Integer.MAX_VALUE & 18 + paramInt * this.strVal1.hashCode() * this.strVal2.hashCode();
  }
