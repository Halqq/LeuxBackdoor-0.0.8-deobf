...
public class BasicInterpreter extends Interpreter implements Opcodes {
  ...
  public BasicValue naryOperation(AbstractInsnNode paramAbstractInsnNode, List paramList) throws AnalyzerException {
  ...
  public BasicValue merge(BasicValue paramBasicValue1, BasicValue paramBasicValue2) {
    return !paramBasicValue1.equals(paramBasicValue2) ? BasicValue.UNINITIALIZED_VALUE : paramBasicValue1;
  }
  ...
  public void returnOperation(AbstractInsnNode paramAbstractInsnNode, Value paramValue1, Value paramValue2) throws AnalyzerException {
    returnOperation(paramAbstractInsnNode, (BasicValue)paramValue1, (BasicValue)paramValue2);
  }
  ...
  public Value ternaryOperation(AbstractInsnNode paramAbstractInsnNode, Value paramValue1, Value paramValue2, Value paramValue3) throws AnalyzerException {
    return ternaryOperation(paramAbstractInsnNode, (BasicValue)paramValue1, (BasicValue)paramValue2, (BasicValue)paramValue3);
  }
  ...
  public Value binaryOperation(AbstractInsnNode paramAbstractInsnNode, Value paramValue1, Value paramValue2) throws AnalyzerException {
    return binaryOperation(paramAbstractInsnNode, (BasicValue)paramValue1, (BasicValue)paramValue2);
  }
  
  public Value unaryOperation(AbstractInsnNode paramAbstractInsnNode, Value paramValue) throws AnalyzerException {
    return unaryOperation(paramAbstractInsnNode, (BasicValue)paramValue);
  }
  
  public Value copyOperation(AbstractInsnNode paramAbstractInsnNode, Value paramValue) throws AnalyzerException {
    return copyOperation(paramAbstractInsnNode, (BasicValue)paramValue);
  }
