...
public abstract class MethodVisitor {
  ...
  public AnnotationVisitor visitAnnotation(String paramString, boolean paramBoolean) {
    return (this.mv != null) ? this.mv.visitAnnotation(paramString, paramBoolean) : null;
  }
  
  public AnnotationVisitor visitTypeAnnotation(int paramInt, TypePath paramTypePath, String paramString, boolean paramBoolean) {
    if (this.api < 327680)
      throw new RuntimeException(); 
    return (this.mv != null) ? this.mv.visitTypeAnnotation(paramInt, paramTypePath, paramString, paramBoolean) : null;
  }
  
  public AnnotationVisitor visitParameterAnnotation(int paramInt, String paramString, boolean paramBoolean) {
    return (this.mv != null) ? this.mv.visitParameterAnnotation(paramInt, paramString, paramBoolean) : null;
  }
  ...
  public AnnotationVisitor visitInsnAnnotation(int paramInt, TypePath paramTypePath, String paramString, boolean paramBoolean) {
    if (this.api < 327680)
      throw new RuntimeException(); 
    return (this.mv != null) ? this.mv.visitInsnAnnotation(paramInt, paramTypePath, paramString, paramBoolean) : null;
  }
  ...
  public AnnotationVisitor visitTryCatchAnnotation(int paramInt, TypePath paramTypePath, String paramString, boolean paramBoolean) {
    if (this.api < 327680)
      throw new RuntimeException(); 
    return (this.mv != null) ? this.mv.visitTryCatchAnnotation(paramInt, paramTypePath, paramString, paramBoolean) : null;
  }
  ...
  public AnnotationVisitor visitLocalVariableAnnotation(int paramInt, TypePath paramTypePath, Label[] paramArrayOfLabel1, Label[] paramArrayOfLabel2, int[] paramArrayOfint, String paramString, boolean paramBoolean) {
    if (this.api < 327680)
      throw new RuntimeException(); 
    return (this.mv != null) ? this.mv.visitLocalVariableAnnotation(paramInt, paramTypePath, paramArrayOfLabel1, paramArrayOfLabel2, paramArrayOfint, paramString, paramBoolean) : null;
  }
