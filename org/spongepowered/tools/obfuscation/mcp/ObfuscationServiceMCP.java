...
public class ObfuscationServiceMCP implements IObfuscationService {
  ...
  public Set getSupportedOptions() {
    return (Set)ImmutableSet.of("reobfSrgFile", "reobfSrgFiles", "reobfNotchSrgFile", "reobfNotchSrgFiles", "outSrgFile", "outNotchSrgFile", (Object[])new String[] { "outRefMapFile" });
  }
  
  public Collection getObfuscationTypes() {
    return (Collection)ImmutableList.of(new ObfuscationTypeDescriptor("searge", "reobfSrgFile", "reobfSrgFiles", "outSrgFile", ObfuscationEnvironmentMCP.class), new ObfuscationTypeDescriptor("notch", "reobfNotchSrgFile", "reobfNotchSrgFiles", "outNotchSrgFile", ObfuscationEnvironmentMCP.class));
  }
}
